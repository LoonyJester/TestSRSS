...
namespace Web.App_Code {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class PurchaseOrderDetailDataTable : global::System.Data.TypedTableBase<PurchaseOrderDetailRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PurchaseOrderDetailRow AddPurchaseOrderDetailRow(int PurchaseOrderID, short OrderQty, int ProductID, decimal ReceivedQty, decimal RejectedQty, decimal StockedQty) {
...
namespace Web.App_Code.DataSet2TableAdapters {
    ...
    public partial class PurchaseOrderDetailTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Purchasing].[PurchaseOrderDetail] WHERE (([PurchaseOrderID] = @Origi" +
                "nal_PurchaseOrderID) AND ([PurchaseOrderDetailID] = @Original_PurchaseOrderDetai" +
                "lID))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Purchasing].[PurchaseOrderDetail] SET [PurchaseOrderID] = @PurchaseOrderID, [OrderQty] = @OrderQty, [ProductID] = @ProductID, [ReceivedQty] = @ReceivedQty, [RejectedQty] = @RejectedQty WHERE (([PurchaseOrderID] = @Original_PurchaseOrderID) AND ([PurchaseOrderDetailID] = @Original_PurchaseOrderDetailID))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PurchaseOrderID, PurchaseOrderDetailID, OrderQty, ProductID, ReceivedQty, " +
                "RejectedQty, StockedQty FROM Purchasing.PurchaseOrderDetail";
        ...
        public virtual int Fill(DataSet2.PurchaseOrderDetailDataTable dataTable) {
        ...
        public virtual DataSet2.PurchaseOrderDetailDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet2.PurchaseOrderDetailDataTable dataTable = new DataSet2.PurchaseOrderDetailDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet2.PurchaseOrderDetailDataTable dataTable) {
